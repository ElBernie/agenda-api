...
let EventsService = class EventsService {
    ...
    create(createEventInput) {
        const event = this.eventRepository.create(Object.assign(Object.assign({}, createEventInput), { id: (0, uuid_1.v4)(), startingDate: createEventInput.startingDate }));
    ...
    async update(id, updateEventInput) {
        const update = await this.eventRepository.updateOne({ id: id }, {
            $set: {
